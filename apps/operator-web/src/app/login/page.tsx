...
export default function LoginPage() {
  ...
  const [organisationRole, setOrganisationRole] = useState("VENDOR");
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      if (!FLEET_ROLES.includes(result.role)) {
        setError("This portal is for Fleet Operator and Vendor accounts. Corporate accounts should use Corporate Web.");
        return;
      }
